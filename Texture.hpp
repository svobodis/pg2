...
private:
    ...
    static inline GLuint ckboard_ = 0; // class-shared ckboard variable. gen_ckboard() is called just once.
    GLuint name_{ 0 }; // set default-constructed texture to ckboard pattern
};
